          ...
          >
            ...
            {result.suggest_start_chat && (
              <motion.div
                ...
                style={{ background: 'rgba(241, 90, 42, 0.05)', border: '2px solid rgba(241, 90, 42, 0.2)' }}
              >
                <div className="flex items-start space-x-4">
                  <svg className="w-10 h-10 flex-shrink-0" style={{ color: '#F15A2A' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                  </svg>
                  <div className="flex-1">
                    <p className="mb-4 font-medium" style={{ fontFamily: "'Inter', sans-serif", color: '#3F3F3F' }}>

...
class JournalEntry(models.Model):
    ...
    sentiment_score = models.FloatField(default=0.0, null=True, blank=True, help_text="Sentiment: -1.0 (negative) to +1.0 (positive)")
    sentiment_label = models.CharField(max_length=20, default='neutral', help_text="Sentiment label: positive, neutral, or negative")
    intensity_score = models.FloatField(null=True, blank=True, help_text="Emotional intensity: 0.0 to 1.0")
